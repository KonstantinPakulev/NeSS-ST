...
from source.models.keynet.module import KeyNet
...
class DetectorWrapper(ModuleWrapper):
    ...
    def __init__(self, module_config, experiment_config):
        ...
        self.keynet = KeyNet.from_config(module_config)
    ...
    def _forward_branch(self, engine, device, i, batch, bundle, endpoint):
        ...
        scorei = self.keynet(image_grayi)
    ...
    def _process_branch(self, engine, device, i, batch, inference_bundle, endpoint, eval_params):
        ...
        kp_scorei, kpi = select_kp(scorei,
                                   nms_size, k,
                                   score_thresh=score_thresh, border_size=nms_size,
                                   return_score=True)
...
# TODO. Key.Net hard-codes the number of points they select for each level.
