...
from source.models.caps.model_utils import conv, upconv, class_for_name
...
class CAPSNet(nn.Module):
    ...
    def __init__(self, device):
        super().__init__()
        self.device = device
        self.net = ResUNet().to(self.device)
    ...
    def extract_features(self, xc, xf, im, coord):
        """
...
class ResUNet(nn.Module):
    def __init__(self, encoder='resnet50', pretrained=True, coarse_out_ch=128, fine_out_ch=128):
