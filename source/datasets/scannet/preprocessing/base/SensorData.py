...
class RGBDFrame():
  ...
  def load(self, file_handle):
    ...
    # self.color_data = ''.join([str(i) for i in list(struct.unpack('c'*self.color_size_bytes, file_handle.read(self.color_size_bytes)))])
    # self.depth_data = ''.join([str(i) for i in list(struct.unpack('c'*self.depth_size_bytes, file_handle.read(self.depth_size_bytes)))])
